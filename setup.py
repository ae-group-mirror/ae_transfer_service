...
setup_kwargs = {
 ...
 '[![LatestPyPIrelease](\n'
 '    https://img.shields.io/gitlab/pipeline/ae-group/ae_transfer_service/release0.3.14?logo=python)](\n'
 '    https://gitlab.com/ae-group/ae_transfer_service/-/tree/release0.3.14)\n'
